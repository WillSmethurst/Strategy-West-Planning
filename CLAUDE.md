...
**Current applications**: the cream variant is applied to `<section class="services-section">` ("What We Do") on `index.html`. No section currently uses the charcoal variant; its asset and class remain defined for future use.
